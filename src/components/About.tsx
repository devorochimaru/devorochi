          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            >
              <div className="relative">
                <ImageWithFallback
                  src="https://files.catbox.moe/ig53uj.jpg"
                  alt="Orochi Profile"
            ...
            >
              <p className="text-gray-300 mb-4">
                I'm a passionate BCA student with a deep fascination for crafting beautiful, 
                intuitive, and futuristic web experiences. My journey in frontend development 
                started with curiosity and evolved into a relentless pursuit of perfection in 
            ...
            >
              <p className="text-gray-300 mb-4">
                I specialize in modern web technologies including <span className="text-blue-400">HTML5</span>, 
                <span className="text-blue-400"> CSS3</span>, <span className="text-purple-400">JavaScript</span>, and 
                <span className="text-purple-400"> React</span>. I believe in writing clean, maintainable code 
                and creating interfaces that feel like they belong in the future.
              </p>
            </motion.div>
            ...
            >
              <p className="text-gray-300">
                When I'm not coding, you'll find me exploring cutting-edge design systems, 
                experimenting with new animation libraries, or contributing to open-source projects. 
                My goal is to bridge the gap between stunning design and flawless functionality.
              </p>
            </motion.div>
          </div>
        </motion.div>
